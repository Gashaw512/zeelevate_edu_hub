...
export const founders = [
  ...
  },
  {
    name: "Kaleb",
    // role: "CTO & Co-Founder",
    bio: ["Kaleb is passionate about helping young people gain the skills they need to succeed in business, tech, and life. His interest in digital strategy and entrepreneurship grew through hands-on experience and was shaped by his studies in Quantitative Finance and a master’s degree in Data Science.", "At IBM, he works as a Business Planning Analyst, where he applies analytical thinking to real-world business challenges. Through his work with ZEELEVATE, he helps students explore career readiness, marketing, and digital literacy in a way that is practical, engaging, and relevant.","With a focus on making complex ideas easier to understand, Kaleb is dedicated to guiding the next generation as they build confidence, sharpen their goals, and create opportunities for themselves and their communities."],
